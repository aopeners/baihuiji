...
public class Trade_statistic extends Fragment {
    ...
    public View onCreateView(LayoutInflater paramLayoutInflater, @Nullable ViewGroup paramViewGroup, @Nullable Bundle paramBundle) {
        ...
        this.sector = ((Sector) paramViewGroup.findViewById(R.id.trad_static_sector));
        loadView(paramViewGroup);
        return view;
    }
    ...
    private void swich() {
        if (layoutm.getVisibility() == View.VISIBLE) {
            ...
            sector.setWight(statisticNum[0][0],statisticNum[0][1],statisticNum[0][2],statisticNum[0][3]);
        }
    }
    ...
    private void onSelectMerchant(String merChantId) {
        ...
        String value[] = {applaication.getDate("operateName"), merChantId, BaihuijiNet.getTime("yyyyMM")};
